...
import { IExtensionGalleryManifestService, IExtensionGalleryManifest, ExtensionGalleryServiceUrlConfigKey, ExtensionGalleryAuthProviderConfigKey, ExtensionGalleryManifestStatus, ExtensionGalleryResourceType, getExtensionGalleryManifestResourceUri } from '../../../../platform/extensionManagement/common/extensionGalleryManifest.js';
...
export class WorkbenchExtensionGalleryManifestService extends ExtensionGalleryManifestService implements IExtensionGalleryManifestService {
	...
	private static readonly MICROSOFT_AUTH_SCOPES = ['https://marketplace.visualstudio.com/.default'];
